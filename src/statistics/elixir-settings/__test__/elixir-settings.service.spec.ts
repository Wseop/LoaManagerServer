...
describe('ElixirSettingsService', () => {
    ...
    beforeEach(async () => {
        ...
        elixirSettingsService =
            module.get<ElixirSettingsService>(ElixirSettingsService);
        elixirSettingModel =
            module.get<Model<ElixirSetting>>(getModelToken(ElixirSetting.name));
    });

    describe('findElixirSettings', () => {
        it('should return array of ElixirSetting', async () => {
            const result = await elixirSettingsService.findElixirSettings('className');
    ...
    describe('upsertElixirSetting', () => {
        it('should return an ElixirSetting', async () => {
            ...
            expect(jest.spyOn(elixirSettingModel, 'findOneAndUpdate')).toBeCalledTimes(1);
        });
    });
